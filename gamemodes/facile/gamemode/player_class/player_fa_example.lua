...
PLAYER.DisplayName			= "Facile Example"

PLAYER.Info = "Example player class!"
...
function PLAYER:Loadout()
	...
	GAMEMODE:LoadDeathmatchLoadout( p )
	
	--GAMEMODE:TrailSetup( p )
end

player_manager.RegisterClass( "player_fa_example", PLAYER, "player_facile" )