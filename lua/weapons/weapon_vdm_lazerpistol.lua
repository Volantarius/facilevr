...
SWEP.WorldModel = "models/weapons/w_laser.mdl"
...
if CLIENT then
	...
	killicon.Add( "weapon_vdm_lazerpistol", "killicons/famas", Color(255,255,255,255) )
...
local primary_sfx = Sound( "Vol_GE_Moonraker.Single" )

function SWEP:PrimaryAttack()
	if ( !self:CanPrimaryAttack() ) then return end
	
	self:EmitSound( primary_sfx )
	
	self:ShootBullet( 32, 1, 0.0, self.Primary.Ammo, 2.0 )
...
function SWEP:ShootBullet( damage, num_bullets, aimcone, ammo_type, force, tracer )
	...
	bullet.TracerName = "tracer_vdm_lazzer"
...
function SWEP:DoImpactEffect( tr, nDamageType )
	...
	util.Effect( "impact_vol_displace_blue", ed )
