...
SWEP.ViewModel = Model("models/cod4/weapons/v_colt45.mdl")
--SWEP.WorldModel = Model("models/cod4/weapons/w_colt45.mdl")
...
if CLIENT then
	killicon.Add( "weapon_vcod_colt45", "killicons/p228", Color(255, 255, 255, 255) )
...
local sfxSingle = Sound( "Weapon_CoD4_Colt45.Single" )
