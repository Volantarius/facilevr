...
SWEP.PrintName 	= "MP5"-- REPLACES mp5
SWEP.Author = "Volantarius"
SWEP.Category = "VCOD"

SWEP.Spawnable = true

SWEP.ViewModel = Model("models/cod4/weapons/v_mp5.mdl")
...
if CLIENT then
	killicon.Add( "weapon_vcod_mp5", "killicons/mp5", Color(255, 255, 255, 255) )
