...
SWEP.PrintName 	= "SKORPION"-- REPLACES MAC-10
SWEP.Author = "Volantarius"
SWEP.Category = "VCOD"

SWEP.Spawnable = true

SWEP.ViewModel = Model("models/cod4/weapons/v_skorpion.mdl")
...
if CLIENT then
	killicon.Add( "weapon_vcod_skorpion", "killicons/mac10", Color(255, 255, 255, 255) )
...
local sfxSingle = Sound( "Weapon_CoD4_Skorpion.Single" )
