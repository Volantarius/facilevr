...
SWEP.ViewModel = Model("models/cod4/weapons/v_usp.mdl")
--SWEP.WorldModel = Model("models/cod4/weapons/w_usp.mdl")
...
if CLIENT then
	killicon.Add( "weapon_vcod_usp", "killicons/usp", Color(255, 255, 255, 255) )
...
local sfxSingle = Sound( "Weapon_CoD4_USP.Single" )
