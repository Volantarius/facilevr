...
SWEP.PrintName 	= "BERETTA Silenced"
SWEP.Author = "Volantarius"
SWEP.Category = "VCOD"

SWEP.Spawnable = true

SWEP.ViewModel = Model("models/cod4/weapons/v_beretta_silencer.mdl")
...
if CLIENT then
	killicon.Add( "weapon_vcod_beretta_s", "killicons/csgo_usp_silencer", Color(255, 255, 255, 255) )

	SWEP.WepSelectIcon = surface.GetTextureID( "killicons/csgo_usp_silencer" )
...
local sfxSingle = Sound( "Vol_GE_Silencer.Single" )
